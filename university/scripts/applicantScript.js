$(document).ready(function () {
    ...
    function loadallData() {
        $.ajax({
            url: "https://localhost:44348/api/universities/" + uniId + "/offers/" + offerId + "/applications",
            method: "get",
            headers: {
    ...
    function loadData(id) {
        $.ajax({
            url: "https://localhost:44348/api/universities/" + uniId + "/offers/" + offerId + "/applications/"+id,
            method: "get",
            headers: {
                ContentType: "application/json",
                Authorization: "Basic " + btoa(un + ":" + pw)
            ...
            complete: function (xmlHttp, status) {
                if (xmlHttp.status == 200) {
                    ...
                    //alert($("#studentId").val() + "\n" + $("#appStatus").val());
                    $("#appId").html(data.id);
                    $("#oTitle").html(data.universityOffer.title);
